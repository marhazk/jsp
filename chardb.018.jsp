		...
		while (eventrst.next())
		{
			...
			if (eventenable == 0)
			{
				...
				if ((snow_d == eday_start) && (eday == 1))
					eventnum++;
				out.println("<br><B>EVENT CHECKED</b>: ID "+eid+" Requires: "+eventnum+" out of "+eventlimit+" : (CURRENT: D"+snow_d+" HH:MM "+snow_hh+":"+snow_mm+") (STARTED: D"+eday_start+" HH:MM "+ehh_start+":"+emm_start+")");
...
%>
<center>
<img src="http://perfectworld.sytes.net/index/gamemap/?postype=3">
