...
<%
	...
	numC++;
	out.println("https://perfectworld.sytes.net/iweb/chardb.jsp?online=1&counter="+numC);
%>
">
<META HTTP-EQUIV=Window-target CONTENT=shoutboxform>
</head>
<P><a href="https://perfectworld.sytes.net/iweb/chardb.jsp?online=1&counter=<%out.println(numC);%>">Click here to continue to the next session</a>
