...
/*    */     try
/*    */     {
/* 37 */       RoleStatusPair o = (RoleStatusPair)super.clone();
/* 38 */       o.key = ((RoleId)this.key.clone());
/* 39 */       o.value = ((GRoleStatus)this.value.clone());
/* 40 */       return o;
/*    */     } catch (Exception e) {
/*    */     }
/* 43 */     return null;
 ...
 * Qualified Name:     protocol.RoleStatusPair
