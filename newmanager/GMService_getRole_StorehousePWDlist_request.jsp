...
<form action=GMService_getRole_StorehousePWDlist_response.jsp method=post>
<table align=center border cellpadding=2>
<tr><th colspan=2 align=center><%=LocaleUtil2.getMessage(request,"GMService_getRole_StorehousePWDlist_title")%></th></tr>
<tr><th align=center>Argument</th><th>Comment</th></tr>
<tr><td align=center><%=LocaleUtil2.getMessage(request,"RoleControl_getRoleList_userid_title")%>:<input type=text name=GMService_getRole_StorehousePWDlist_userid></td><td align=center></td></tr>
