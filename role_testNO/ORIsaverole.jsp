...
<%
	...
	LogFactory.getLog("ORIsaverole.jsp").info("putRoleInfo, "+role.getLogString()+",result="+success+",operator=" + AuthFilter.getRemoteUser(session) );
%>
...
<%
	if( success )
		//out.print( "角色信息保存成功。&nbsp;&nbsp;&nbsp;&nbsp;" );
		out.print( "Successfully updated the role information。&nbsp;&nbsp;&nbsp;&nbsp;" );
